...
\title{Zinc, an advanced scriptable Canvas.\\The pre 3.3 (3.294) Reference Manual.\\\small{[CENA technical Note NT03-532]} }
...
\subsection{Differences between 3.294 and 3.2.6 release}
\begin{itemize}
...
\begin{blockindent}
  ...
  \item{\tt\large
    ...
    If {\tt recursive} is specified it controls if the search should proceed
    down the item hierarchy or not.
  ...
  \item{\tt\large
    ...
    a group to start with instead of the root group and recursive tells
